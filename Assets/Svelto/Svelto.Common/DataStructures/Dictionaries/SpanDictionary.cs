...
namespace Svelto.DataStructures
{
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        public bool TryGetValue(TKey key, out TValue result)
        {
            ...
            {
                result = _values.Span[(int) findIndex];
                return true;
            }
        ...
        public ref TValue GetValueByRef(TKey key)
        {
            if (TryFindIndex(key, out var findIndex))
            {
                return ref _values.Span[(int) findIndex];
            }
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => _values.Span[(int) GetIndex(key)];
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        bool AddValue(TKey key, in TValue value, out uint indexSet)
        {
            ...
            {
                {
                    ...
                    do
                    {
                            ...
                            _valuesInfo[currentValueIndex].key.Equals(key) == true)
                        {
                            ...
                            valuesSpan[currentValueIndex] = value;
            ...
            valuesSpan[(int) _freeValueCellIndex] = value;
        ...
        public bool Remove(TKey key)
        {
            ...
            if (indexToValueToRemove != _freeValueCellIndex)
            {
                ...
                _values.Span[indexToValueToRemove] = _values.Span[(int) _freeValueCellIndex];
            }
        ...
        {
            return ref _values.Span[(int) index];
        }
        ...
        public struct FasterDictionaryKeyValueEnumerator : IEnumerator<KeyValuePairFast>
        {
            ...
            public KeyValuePairFast Current => new KeyValuePairFast(_dic._valuesInfo, _dic._values.memory, _index);
        ...
        {
            readonly Memory<TValue> _dicValues;
            readonly Node[]   _dickeys;
            readonly int      _index;

            public KeyValuePairFast(Node[] keys, Memory<TValue> dicValues, int index)
            {
            ...
            public ref TValue Value => ref _dicValues.Span[_index];
        }
    }
}