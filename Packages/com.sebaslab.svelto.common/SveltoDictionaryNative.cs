...
namespace Svelto.DataStructures.Native2
{
        ...
        where TKey : unmanaged, IEquatable<TKey> where TValue : struct
    {
        ...
        {
            _dictionary =
                new DataStructures2.SveltoDictionary<TKey, TValue, NativeStrategy<Svelto.DataStructures2.SveltoDictionaryNode<TKey>>, NativeStrategy<TValue>, NativeStrategy<int>>(size, nativeAllocator);
        }
        ...
        DataStructures2.SveltoDictionary<TKey, TValue, NativeStrategy<DataStructures2.SveltoDictionaryNode<TKey>>, NativeStrategy<TValue>, NativeStrategy<int>> _dictionary;
    }
}